...
class Dirigeants(models.Model):
    ...
    civilite_dirigeant = models.CharField(        verbose_name='civilite_dirigeant',max_length=30)
    ...
    prenom_dirigeant = models.CharField(        verbose_name='prenom_dirigeant',max_length=30)
    representants_id = models.ForeignKey(Informations_generales, on_delete=models.CASCADE, primary_key=True)
    nom_prenom_dirigeant = models.CharField(        verbose_name='nom_prenom_dirigeant', max_length=30)
...
#     representants_id = models.ForeignKey(Informations_generales.representants_id, on_delete=models.CASCADE, primary_key=True)
...
#      representants_id = models.ForeignKey(Informations_generales.representants_id, on_delete=models.CASCADE)
...
#     exercice_id = models.ForeignKey(Exercices.exercices_id, on_delete=models.CASCADE)
...
#     activite_id = models.ForeignKey(Objets_activites.activite_id, on_delete=models.CASCADE)
...
#     action_representation_interet_id = models.ForeignKey(Observations.action_representation_interet_id, on_delete=models.CASCADE)
