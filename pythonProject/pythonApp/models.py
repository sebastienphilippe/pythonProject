...
class Objets_activites(models.Model):
    ...
    date_publication_activite =  models.CharField(null=True,blank=True,max_length=30)
    identifiant_fiche = models.CharField(null=True,blank=True,max_length=30)
    objet_activite = models.CharField(null=True,blank=True,max_length=30)
...
class Decisions_concernees(models.Model):
    ...
    Decisions_concernees = models.IntegerField(      verbose_name='activite_id', primary_key=True)
